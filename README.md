...
No painel de cada BoxNode, o seletor **Material** fica ao lado do seletor de box. Ao confirmar uma alteração, ela é salva como material ativo no Raspberry e passa a valer para as capturas automáticas e manuais seguintes. Se “Material padrão do Raspberry” estiver selecionado, o sistema remove a configuração remota e usa os valores `MATERIAL_*` do `.env`. No catálogo também estão Ureia granulada (0,75 t/m³), NPK granulado (1,03 t/m³), MAP/DAP (0,98 t/m³), KCl (1,08 t/m³), sulfato de amônio (0,93 t/m³) e fertilizante orgânico (0,60 t/m³). Essas são médias de referência; prevalece a densidade da ficha técnica do fornecedor quando disponível.
